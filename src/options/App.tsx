...
function OptionsPage(props: { theme: Theme; onThemeChange: (theme: Theme) => void }) {
  ...
  return (
    <div className="container w-[560px] mx-auto shadow-md shadow-gray-300 p-8">
      <nav className="mx-auto flex flex-col justify-between items-center">
        <div className="flex justify-center items-center gap-2">
          <img src={logo} className="w-10 h-10 rounded-lg" />
          <h2 className="text-3xl font-semibold mb-0">
            ChatGPT for Wechat (v{getExtensionVersion()})
          </h2>
        </div>
        <div className="flex items-center mt-4">
          This page based on{' '}
          <a href="https://github.com/wong2/chatgpt-google-extension" target="_blank" rel="noreferrer">
            {' '}
            ChatGPT for Google
          </a>
          , Thanks wong2.
      ...
      <main className="mx-auto mt-4">
        ...
        <div className="flex flex-row items-center gap-4">
          ...
          <Text b margin={0}>
            Auto delete conversations generated by wechat
          </Text>
        </div>
      </main>
    </div>
